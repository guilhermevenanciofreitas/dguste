      ...
      try {
        ...
        await db.transaction(async (transaction) => {
          ...
          for (let order of req.body.orders) {
            ...
            const transacao = await db.Pedido1.max('transacao', {transaction})

            const protocolo = transacao ? transacao + 1 : 1
            ...
            await db.Pedido1.create(pedido1, {transaction})

            orders.push({numero: pedido1.numero, protocolo})
