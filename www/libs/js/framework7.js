...
function Money () {
	document.getElementById("Money").value = (document.getElementById("Money").value).replace(".","");
	document.getElementById("Money").value = (document.getElementById("Money").value / 100).toFixed(2);
}

function MoneyAddProduto () {
	document.getElementById("MoneyAddProduto").value = (document.getElementById("MoneyAddProduto").value).replace(".","");
	document.getElementById("MoneyAddProduto").value = (document.getElementById("MoneyAddProduto").value / 100).toFixed(2);
}
...
(function () {
    ...
    window.Framework7 = function (params) {
        ...
        ************   Modals   ************
        ...
        app.addProduto = function (text, title, valor, callbackOk, callbackCancel) {
            if (typeof title === 'function') {
                callbackCancel = arguments[2];
                callbackOk = arguments[1];
                title = undefined;
            ...
            return app.modal({
                ...
                afterText: '<div class="input-field modal-input-double">'+
                              '<input type="number" name="modal-username" value="' + valor.toFixed(2) + '" class="modal-text-input" id="MoneyAddProduto" onkeyup="MoneyAddProduto()">' +
                           '</div>' +
                           '<div class="input-field modal-input-double">' +
                              '<br>Quantidade: <input type="number" name="modal-password" class="modal-text-input" placeholder="1">' +
                           '</div>',
                buttons: [
                    {
                        text: "Cancelar"
        ...
        app.editProduto = function (text, title, NUMLOTE, PVENDA, QTDE, DTVALIDADE, callbackOk, callbackCancel) {
            if (typeof title === 'function') {
                callbackCancel = arguments[2];
                callbackOk = arguments[1];
                title = undefined;
            ...
            return app.modal({
                ...
                title: typeof title === 'undefined' ? app.params.modalTitle : title,
                afterText: '<div class="input-field modal-input-double">'+
                '<input type="date" name="modal-validade" value="' + DTVALIDADE + '" class="modal-text-input">' +
                '</div>' +
                '<div class="input-field modal-input-double">' +
                '<br>Lote: <input type="number" name="modal-lote" class="modal-text-input" value="' + NUMLOTE + '">' +
                '</div>' +
                '<div class="input-field modal-input-double">' +
                '<br>Preço: <input type="number" name="modal-valor" class="modal-text-input" value="' + PVENDA.toFixed(2) + '" id="Money" onkeyup="Money()">' +
                '</div>'+
                '<div class="input-field modal-input-double">' +
                '<br>Quantidade: <input type="number" name="modal-qtde" class="modal-text-input" value="' + QTDE + '">' +
                '</div>',
                buttons: [
                    {
                        text: "Cancelar"
                ...
                onClick: function (modal, index) {
                    var Valor = $(modal).find('.modal-text-input[name="modal-valor"]').val();
                    var Quantidade = $(modal).find('.modal-text-input[name="modal-qtde"]').val();
                    var Lote = $(modal).find('.modal-text-input[name="modal-lote"]').val();
                    var Validade = $(modal).find('.modal-text-input[name="modal-validade"]').val();
                    if (index === 0 && callbackCancel) callbackCancel(Valor, Quantidade, Lote, Validade);
                    if (index === 1 && callbackOk) callbackOk(Valor, Quantidade, Lote, Validade);
                }
            });
        };
